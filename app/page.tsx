...
function HackerTerminal() {
  ...
  const lines = [
    ...
    "0xmfbk (root)",
    ip ? `$ nmap -A ${ip}` : "$ nmap -A ...",
    "Starting Nmap x.xx ( https://nmap.org ) at 1997 22:00 UTC",
    ip ? `Nmap scan repoart for ${ip}` : "Nmap scan report for ...",
    "PORT     STATE SERVICE VERSION",
    "22/tcp   open  ssh     OpenSSH x.xp1 Ubuntu xubuntux.x (Ubuntu Linux; protocol x.0)",
    "80/tcp   open  http    Apache httpd x.x.x ((Ubuntu))",
    "443/tcp  open  https   OpenSSL x.x.x 1997",
